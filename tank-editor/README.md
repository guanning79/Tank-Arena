...
python tank_editor.py add --texture textures/basic.png --tank-label player_basic --speed 6 --tank-hit-point 1 --bound-min-x 2 --bound-min-y 1 --bound-max-x 29 --bound-max-y 30 --shell-size 2 --shell-speed 9 --shell-color red
